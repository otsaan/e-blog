...
<div class="wrapper-page">
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal m-t-20" role="form" method="POST" action="{{ url('/register') }}">
                ...
                <div class="form-group ">
                    <div class="col-xs-12">
                        <input class="form-control" type="text" required="" name="username" placeholder="Nom d'utilisateur">
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-sm-12 text-center">
            <p>
                Vous êtes dèja inscris?<a href="/login" class="text-primary m-l-5"><b>S'inscrire</b></a>
            </p>
        </div>
    </div>
